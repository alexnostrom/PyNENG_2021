...
def parse_cdp_neighbors(command_output):
    ...
    for line in command_output.split('\n'):
        ...
        if ">" in line:
            ...
            right_host, left_intf, left_intf_num, *_, right_intf, right_intf_num = column
            devices_dict[(host_name, left_intf + left_intf_num)] = (right_host, right_intf + right_intf_num)
    return devices_dict
